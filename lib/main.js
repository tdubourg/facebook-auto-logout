...
function removeCookie(aCookie) {
  // Just remove the user id cookie. It's enough to log you out and will not prevent the 2-steps authentication
  // to remember your computer
  if (aCookie.name == "c_user") {
